<div>
    ...
    <div class="flex items-center justify-between px-2 text-base font-medium text-gray-700">
        <div>Guia de Despacho de Especie</div>
    </div>
    <div class="mt-2">
    <div class="flex max-h-[600px] w-full flex-col overflow-y-scroll">
        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-12 bg-neutral-100 mt-3 shadow-2xl">
            ...
            <div class="text-center col-span-2 p-2">
                <input type="date" wire:model.defer="fechainicial" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50">
            </div>
            <div class="text-center col-span-2 p-2">
                <input type="date" wire:model="fechafinal" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50">
            </div>
            ...
            <div class="col-span-12 font-bold text-primary-800 text-right">
                ...
                @foreach ($exportadoraxplanificacion as $expplan )
                    ...
                    <div class="col-span-4 mt-1 ">
                            <input type="text" class="uppercase h-10 border mt-1 rounded px-4 w-full bg-gray-200" value="{{$expplan->planificacioncosecha->cuartel->campo->empresa->razon_social}}">
                    ...
                    <div class="col-span-4 mt-1">
                            <input type="text" class="uppercase h-10 border mt-1 rounded px-4 w-full bg-gray-200" value="{{$expplan->planificacioncosecha->cuartel->campo->empresa->direccion}}">
                    </div>
                    <div class="col-span-6">
                    </div>
                    <div class="col-span-2 text-right mt-2 p-1">
                    ...
                    <div class="col-span-4 mt-1">
                            <input type="text" class="uppercase h-10 border mt-1 rounded px-4 w-full bg-gray-200" value="{{ date('Y-m-d H:i:s') }}">
                    </div>
                    ...
                    <div class="col-span-1 mt-6">
                            <input type="text" class="uppercase h-10 border mt-1 rounded px-4 w-full bg-gray-200" value="{{$expplan->empresa->rut}}">
                    </div>
                    <div class="col-span-1 mt-7 p-1">
                            <label class="p-1 font-medium">Exportadora</label>
                    </div>
                    <div class="col-span-4 mt-6">
                            <input type="text" class="uppercase h-10 border mt-1 rounded px-4 w-full bg-gray-200" value="{{$expplan->empresa->razon_social}}">
                    </div>
                    <div class="col-span-1 mt-7 p-1">
                            <label class="p-1 font-medium">Dirección</label>
                    </div>
                    <div class="col-span-4 mt-6">
                            <input type="text" class="uppercase h-10 border mt-1 rounded px-4 w-full bg-gray-200" value="{{$expplan->empresa->direccion}}">
                    </div>
                    ...
                    <div class="col-span-4 mt-1">
                            <input type="text" class="uppercase h-10 border mt-1 rounded px-4 w-full bg-gray-200" value="{{$expplan->empresa->comuna->comuna}}">
                    </div>
                    <div class="col-span-1 mt-2 p-1">
                            <label class="p-1 font-medium">Email</label>
                    </div>
                    <div class="col-span-6 mt-1">
                            <input type="text" class="uppercase h-10 border mt-1 rounded px-4 w-full bg-gray-200" value="{{$expplan->empresa->email}}">
                    </div>
                    <div class="col-span-1 mt-2 p-1 text-left">
                        <label class="borp-1 font-medium">Giro</label>
                    </div>
                    <div class="col-span-6 mt-1">
                        <input type="text" class="uppercase h-10 border mt-1 rounded px-4 w-full bg-gray-200" value="{{$expplan->empresa->giro}}">
                    </div>
