        ...
        <div class="flex flex-row">
                            ...
                            @foreach ($detalleCo as $cosecha)
                                <tr>
                                    ...
                                    <td class="border-dotted w-full mt-3 border-2 border-sky-500">
                                        {{ $cosecha->empresa_id }}</td>
                                    <td class="border-dotted w-full mt-3 border-2 border-sky-500">
                                        {{ $cosecha->tarjaenvase }}.</td>
                                    <td class="border-dotted w-full mt-3 border-2 border-sky-500">{{ $cosecha->kilos }}
                                    </td>
                                    <td class="border-dotted w-full mt-3 border-2 border-sky-500"><button type="button"
            ...
            <div class="w-1/2 mr-5 border-dotted  border-2 border-sky-500 shadow-2xl p-5">
                ...
                <div class="sm:col-span-1 md:col-span-6">
                    <h2 class="text-base font-semibold leading-7 text-gray-900">Datos de la Planificación de la Cosecha
                    </h2>
                </div>
                ...
                {{-- tabla --}}
                <div class="w-full">
                    <h2 class="text-base font-semibold leading-7 text-gray-900 mt-3">Datos de las Empresas Exportadoras
                    </h2>
                    <table class="border-dotted w-full mt-3 border-2 border-sky-500">
                        <thead class="border-dotted w-full mt-3 border-2 border-sky-500">
                            <tr class="border-dotted w-full mt-3 border-2 border-sky-500 bg-secondary-100">
                                ...
                                <td class="border-dotted w-full mt-3 border-2 border-sky-500">Kilos/Reales/Asignados</td>
                        ...
                        <tbody>
                            ...
                            @foreach ($planificacionDatos->exportadoraxplanificacion as $exportadora)
                                <tr>
                                    ...
                                    <td class="border-dotted w-full mt-3 border-2 border-sky-500">
                                        {{ $exportadora->cuentaenvase->saldo }}</td>
                                    <input type="hidden" name="exportadora_id[]" value="{{$exportadora->id}}">
                                    <td class="border-dotted w-full mt-3 border-2 border-sky-500"><input type="text" name="valores[]" class="w-full border-dotted border-2 border-sky-500"></td>
                                    <td class="border-dotted w-full mt-3 border-2 border-sky-500"><input type="text" name="bines[]" class="w-full border-dotted border-2 border-sky-500"></td>
                                </tr>
                ...
                <div class="flex">
                    ...
                    <div class="w-1/2 px-2">
                        <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Envase/Campo
                        </label>
                ...
                <div class="flex">
                    <div class="w-1/2 px-2">
                        ...
                        <input type="text" id="cosechaActual" name="cosechaActual" wire:model.defer="cosechaActual"
                            class="text-center block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    <div class="w-1/2 px-2">
                        <label for="username"
