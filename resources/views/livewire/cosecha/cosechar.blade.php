                ...
                <div class="text-left col-span-1 mr-5 border-2 shadow-xl bg-white rounded-lg p-2">
                    <div class="flex">
                        <div class="w-1/5 px-2">
                            <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Contratista</label>
                        ...
                        <div class="w-1/5 px-2">
                            <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Exportadora</label>
                            <select  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                        ...
                        <table class="border-2">
                            <thead class="border-2">
                                <tr class="border-2 bg-gray-300">
                                    ...
                                    <td class="w-24 border-2 mt-3">Exportadora&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            ...
                            <tbody>
                                @foreach ($detalleCo as $cosecha)
                                    <tr>
                                        ...
                                        <td class="w-full mt-3 border-2"><button
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($planificacionDatos->exportadoraxplanificacion as $exportadora)
                                            <tr>
                                                ...
                                                <td class="w-full mt-3 border-2"><input
                                        ...
                                        @foreach ($planificacionDatos->exportadoraxplanificacion as $exportador)
                                            ...
                                            {{-- {{$exportador->id }},{{$desglose->exportadoraxplanificacion_id}} --}}
                                                @if ($exportador->id == $desglose->exportadoraxplanificacion_id)
                                                    <tr
                                                        class="w-full mt-3 border-2 bg-neutral-50">
                                                        <td class="w-full mt-3 border-2">
