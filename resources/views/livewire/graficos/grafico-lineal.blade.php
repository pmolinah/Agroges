<div>
    <div>
         ...
         <div class="col-span-3 ml-10 ml-5 text-center shadow-xl" style="position: relative; height:40vh; width:150vw ">
            ...
            tooltips: {
                callbacks: {
                    label: function (tooltipItem, data) {
                        return tooltipItem.yLabel + ' kilos'; // Personaliza la etiqueta del tooltip
                    },
                },
            },
...
//        myChartLine.data.labels = labels;
//
//        // Agregar múltiples conjuntos de datos (líneas) para cada año
//        for (var year in dataSets) {
//            if (dataSets.hasOwnProperty(year)) {
//                for (var especie in dataSets[year]) {
//                    if (dataSets[year].hasOwnProperty(especie)) {
//                        myChartLine.data.datasets.push({
//                            label: especie + ' - ' + year,
//                            data: dataSets[year][especie],
//                            borderColor: getBorderColor(myChartLine.data.datasets.length),
//                            backgroundColor: getBackgroundColor(myChartLine.data.datasets.length),
//                            borderWidth: 1,
//                            fill: false
