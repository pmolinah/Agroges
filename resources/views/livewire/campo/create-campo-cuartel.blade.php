<div>
            ...
            <div class="grid sm:grid-cols-1 md:grid-cols-4 gap-4 p-2">
                ...
                <div class="bg-white text-neutral-600 text-left sm:col-span-1 md:col-span-2 grid grid-cols-2 mb-10 ml-2 mr-2 mt-8 mx-auto px-16 py-3 rounded-lg shadow-lg">
                ...
                <div
                    class="sm:col-span-1 md:col-span-2 bg-white mb-10 ml-2 mr-2 mt-8 mx-auto px-5 py-8 rounded-lg shadow-lg">
