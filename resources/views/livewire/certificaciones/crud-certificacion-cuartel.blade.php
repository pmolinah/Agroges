                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                @foreach ($cuartel->certificacionasignadacuartel as $cuartelCertificacioncuartel)
                                                    <tr>
                                                        <th class="border-2">{{$cuartelCertificacioncuartel->certificacion->certificacion }}</th>
                                                        <th class="border-2"><a href="../../{{$cuartelCertificacioncuartel->rutaDocumento}}{{$cuartelCertificacioncuartel->documento}}" target="_blank">
         ...
         <!--Verically centered modal-->
                <div data-te-modal-init
                    ...
                    <div data-te-modal-dialog-ref
                        ...
                        <div
                            class="pointer-events-auto relative flex w-full flex-col rounded-md bg-white">
                            <div
