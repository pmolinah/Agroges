        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-3 borde-neutral-800">
            <div class="">
                <button type="button"
                    ...
                    data-te-toggle="modal" data-te-target="#exampleModalCenterEnvase" data-te-ripple-init data-te-ripple-color="light">
                    Agregar Nuevo Envase
                </button> 
            </div>
            <div class="">
                <h6 class="text-3xl  font-medium leading-tight">Buscar Envase</h6>
            </div>
            <div class="">
                        ...
                        <table class="min-w-full text-center text-sm font-light ">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class=" px-6 py-4">Envase</th>
                                    <th scope="col" class=" px-6 py-4">Tara</th>
