                                ...
                                <div class="">
                                    <div class="border-b border-gray-900/10 pb-12">
                                        ...
                                        <div class="border-b border-gray-900/10 pb-12">
                                                        ...
                                                        <select data-te-select-init data-te-select-filter="true"
                                                            ...
                                                            @foreach ($especies as $especie)
                                                                <option value="{{ $especie->id }}"><label
                                                                        for="username"
                                                                        class="block text-sm font-medium leading-6 text-neutral-900">{{ $especie->especie }}</label>
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            {{-- <div class="border-b border-gray-900/10 pb-12">
                                        <h2 class="text-base font-semibold leading-7 text-gray-900">Certificaciones
                                        </h2>
                                        <p class="mt-1 text-sm leading-6 text-gray-600">Certif</p>

                                        <div class="mt-10 space-y-10">
                                            <fieldset>
                                                <legend class="text-sm font-semibold leading-6 text-gray-900">Certificacion 2
                                                </legend>
                                                <div class="mt-6 space-y-6">
                                                    <div class="relative flex gap-x-3">
                                                        ...
                                                        <div class="text-sm leading-6">
                                                            ...
                                                            <p class="text-gray-500">Get notified when someones
                                                                posts a
                                            ...
                                            <fieldset>
                                                ...
                                                <p class="mt-1 text-sm leading-6 text-gray-600">These are delivered
                                                    via
                                                    SMS
