                ...
                Formulario de Plantación de Especies
                    ...
                    @CSRF
                        ...
                        <div class="grid xs:grid-cols-1 md:lg:xl:grid-cols-12 gap-3 p-5">
                            ...
                            <div class="col-span-4 text-left rounded-lg bg-white p-1 shadow-lg">
                                <div
                                    class="font-bold px-6 py-1 text-neutral-900 bg-neutral-300">
                                    2.- Campo
                                </div>
                                <div class="">
                                        <select class="text-neutral-900 p-2 border-2" id="campo_id"
                                            name="campo_id">
                                        </select>
                                    </h5>
                                </div>
                            ...
                            {{-- inicio --}}
                            <div
                                class="col-span-4 text-left rounded-lg bg-white p-1 shadow-lg">
                                <div
                                    class="font-bold px-6 py-1 text-neutral-900 bg-neutral-300">
                                    3.- Seleccione Cuartel
                                </div>
                                <div class="">
                                        <select class="text-neutral-900 p-2 border-2" id="cuartel_id"
                                            name="cuartel_id">
                                        </select>
                                    </h5>
                                </div>
                            ...
                            <div class="text-left col-span-6 bg-white shadow-lg p-2 rounded-lg">
                                ...
                                <div class="mt-2 text-neutral-900">
                                    <select 
                                        name="contratista_id" class="text-neutral-900 border-2 p-2" id="empresa_id">
                                        <option value=""><label
                            ...
                            <div class="text-left col-span-6 bg-white shadow-lg p-2 rounded-lg">
                                <div class="mt-2">
                                <label class="block text-sm font-medium leading-6 text-neutral-900 font-bold">Observaciones</label>
                            ...
                            <div class="col-span-12 text-center p-4">
                                ...
                                <div class="">
                                <label class="text-sm font-medium leading-6 text-neutral-900 font-bold text-center">Superficie  de Cuartel</label>
                                <div class="mt-2">
                                ...
                                <label class="text-neutral-900">Seleccionar</label>  
                                    ...
                                    <select  name="especie_id" class="text-neutral-900  border-2 p-2" id="especie_id">
                                        ...
                                        @foreach ($especies as $especie)
                                            <option value="{{ $especie->id }}"><label class="">Especie: {{ $especie->especie }}, Variedad: {{ $especie->variedad->variedad}}</label>
                                            </option>
                                        @endforeach
                                    </select>
                            </div>
                             <div class="col-span-2 bg-white rounded-lg shadow-lg text-left p-2">
                                <label class="block text-sm font-medium leading-6 text-neutral-900 font-bold text-center">Fecha Plantación</label>
                                <div class="mt-2">
                            ...
                            <div class="col-span-2 bg-white rounded-lg shadow-lg text-left p-2">
                                <label class="block text-sm font-medium leading-6 text-neutral-900 font-bold text-center">Cantidad Plantas Máxima</label>
                                <div class="mt-2">
                            ...
                            <div class="col-span-2 bg-white rounded-lg shadow-lg text-left p-2">
                                <label class=" block text-sm font-medium leading-6 text-neutral-900 font-bold text-center">Cantidad  Plantada </label>
                                <div class="mt-2">
