    ...
    <div class="py-12">
        <div class="mx-auto sm:px-6 lg:px-8">
                <div class="pb-12 relative">
                    <div class="inline-block absolute left-0 text-left p-1 w-52 rounded-full bg-white shadow"><i class="fa-solid fa-tree mr-3 ml-3"></i>
                            <label class="font-bold">Lista Plantaciones</label>
                    </div>
                    <div class="inline-block absolute right-0">
                        <a href="{{ route('Plantacion.create') }}">
                            <button type="button"
                                class="bg-gray-700 text-white  py-2 px-4 mb-1 rounded hover:bg-gray-600">
                                Nueva Plantación
                            </button>
                        </a>
                    </div>
