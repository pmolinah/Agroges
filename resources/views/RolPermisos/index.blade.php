<x-dashBoard>
    ...
    <div class="py-20">
        ...
        <div class="p-1 w-56 rounded-full bg-white shadow"><i class="fa-solid fa-table-list  mr-3 ml-3"></i><label class="font-bold">Lista de Roles Creados</label></div>
                                    ...
                                    @foreach($Roles as $rol)
                                        ...
                                        class="border-b bg-neutral-100 dark:border-neutral-500 dark:bg-neutral-200">
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4">
                                                ...
                                                <a href="{{ route('roles.edit',$rol->id)}}" class="btn btn-sm btn-warning-800"><i class="fas fa-edit"></i></a>
                                                </button>
                                            </td>
                                            <td class="whitespace-nowrap px-6 py-4">
                                           
                                                <button class="inline-block rounded bg-danger-800 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#dc4c64] transition duration-150 ease-in-out hover:bg-danger-700 hover:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] focus:bg-danger-600 focus:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] focus:outline-none focus:ring-0 active:bg-danger-700 active:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(220,76,100,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)]" onclick='EliminarRole({{ $rol->id }})'><i class="fas fa-trash"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
