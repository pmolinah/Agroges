        ...
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          ...
          <div class="lg:col-span-2">
            ...
            {{-- <div class="md:col-span-2">
                ...
                <input type="text" id="rut" required name="rut" placeholder="Ej:12345678-K" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ $user->rut }}"/>
            </div> --}}
              
              <div class="md:col-span-4">
                <label for="full_name">Nombre.(*)</label>
                <input type="text" required name="name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ $user->name }}" />
              </div> 
     

              <div class="md:col-span-6">
                <label for="email">Email .(*)</label>
                <input type="text" name="email" name="email" id="email" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ $user->email }}" placeholder="email@domain.com" />
              </div>
             ...
             <div class="md:col-span-4">
                ...
                <div class="md:col-span-6 ">
                 ...
                 <div class="md:col-span-3">
                    ...
                    <input type="text" id="password" required name="password" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" />
                </div>
