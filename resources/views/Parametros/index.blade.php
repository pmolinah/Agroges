                        ...
                        <div class="sm:col-span-1 md:col-span-1">
                            ...
                            <ul class="mb-5 flex list-none flex-row flex-wrap border-b-0 pl-0 bg-secondary-100" role="tablist"
                                ...
                                <li role="presentation" class="flex-auto text-center">
                                    <a href="#tabs-bodega"
                                        class="my-2 block border-x-0 border-b-2 border-t-0 border-transparent px-7 pb-3.5 pt-4 text-xs font-medium uppercase leading-tight text-neutral-500 hover:isolate hover:border-transparent hover:bg-neutral-100 focus:isolate focus:border-transparent data-[te-nav-active]:border-primary data-[te-nav-active]:text-primary dark:text-neutral-400 dark:hover:bg-transparent dark:data-[te-nav-active]:border-primary-400 dark:data-[te-nav-active]:text-primary-400"
                                        data-te-toggle="pill" data-te-target="#tabs-bodega" data-te-nav-active
                                        role="tab" aria-controls="tabs-bodega" aria-selected="true">Bodega</a>
                                </li>
                                <li role="presentation" class="flex-auto text-center">
                                    <a href="#tabs-Insumos"
                                        class="my-2 block border-x-0 border-b-2 border-t-0 border-transparent px-7 pb-3.5 pt-4 text-xs font-medium uppercase leading-tight text-neutral-500 hover:isolate hover:border-transparent hover:bg-neutral-100 focus:isolate focus:border-transparent data-[te-nav-active]:border-primary data-[te-nav-active]:text-primary dark:text-neutral-400 dark:hover:bg-transparent dark:data-[te-nav-active]:border-primary-400 dark:data-[te-nav-active]:text-primary-400"
                                        data-te-toggle="pill" data-te-target="#tabs-Insumos" role="tab"
                                        aria-controls="tabs-Insumos" aria-selected="false">Insumos</a>
                                </li>
                                 <li role="presentation" class="flex-auto text-center">
                                    <a href="#tabs-tareas"
                                        class="my-2 block border-x-0 border-b-2 border-t-0 border-transparent px-7 pb-3.5 pt-4 text-xs font-medium uppercase leading-tight text-neutral-500 hover:isolate hover:border-transparent hover:bg-neutral-100 focus:isolate focus:border-transparent data-[te-nav-active]:border-primary data-[te-nav-active]:text-primary dark:text-neutral-400 dark:hover:bg-transparent dark:data-[te-nav-active]:border-primary-400 dark:data-[te-nav-active]:text-primary-400"
                                        data-te-toggle="pill" data-te-target="#tabs-tareas" role="tab"
                                        aria-controls="tabs-tareas" aria-selected="false">Tareas</a>
                                </li>
                            ...
                            <div class="mb-6 ">
                                <div class="hidden opacity-100 transition-opacity duration-150 ease-linear data-[te-tab-active]:block"
                                    id="tabs-bodega" role="tabpanel" aria-labelledby="tabs-home-tab01"
                                    data-te-tab-active> @livewire('parametros.crud-bodega')
                                    
                                </div>
                                <div class="hidden opacity-0 transition-opacity duration-150 ease-linear data-[te-tab-active]:block"
                                    id="tabs-Insumos" role="tabpanel" aria-labelledby="tabs-profile-tab01">
                                     @livewire('parametros.crud-producto')
                                </div>
                                 <div class="hidden opacity-0 transition-opacity duration-150 ease-linear data-[te-tab-active]:block"
                                    id="tabs-tareas" role="tabpanel" aria-labelledby="tabs-profile-tab01">
                                    
                                    @livewire('parametros.crud-tarea')
                                </div>
