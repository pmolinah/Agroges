        ...
        <form action="{{ route('Planificacion.store') }}" method="post">
            ...
            <div class="grid sm:grid-cols-1 md:grid-cols-12 gap-3">{{-- inicio 12 espacios --}}
                ...
                <div
                    ...
                    <div class="col-span-1 p-2 ml-1 h-10 bg-gray-100 flex border-2 border-gray-300 rounded items-center mt-1">
                        <input type="number" id="nuevoskilos" name="nuevoskilos" class="px-4 py-2 appearance-none outline-none text-gray-800 bg-transparent" />
                    </div>
                        ...
                        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                <div class="overflow-hidden">
                                    <div class="w-full rounded-xl border border-gray-200 bg-white py-2 px-2 shadow-md shadow-gray-100">
                                            ...
                                            <table class="min-w-full text-left text-sm font-light" id="grilla">
                                                <thead
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="px-6 py-1 md:block xl:block">Exportadora
                                                        </th>
                                                        <th scope="col" class="px-6 py-1 text-center">Kilos</th>
                                                        <th scope="col" class="px-6 py-1 text-center">Stock/Bins</th>
                                                    ...
                                                    <table class="min-w-full text-left text-sm font-light" id="grilla2">
                                                        <thead
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th scope="col" class="px-6 py-1">TratoxCosecha </th>
                                                                <th scope="col" class="px-6 py-1">Eliminar</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody class="text-warning-200">
