    ...
    >
      <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
        ...
        <div
          ...
          class="fixed inset-0 z-10 bg-neutral-800 lg:hidden"
          style="opacity: 0.5"
          aria-hidden="true"
        ></div>
        ...
        >
          ...
          <div class="flex flex-col flex-shrink-0 h-full px-2 py-4 border-r dark:border-neutral-800 bg-gray-300">
            ...
            <div class="flex-shrink-0">
              <a
                href="{{route('Ver.graficos')}}"
                class="inline-block text-xl font-bold tracking-wider text-neutral-700 uppercase dark:text-light"
              >
               <img src="{{ asset('storage/logoAgrogesAjustado.png') }}" class="bg-cover bg-center bg-auto w-14 rounded-lg shadow-lg shadow-neutral-800">
              </a>
            </div>
          ...
          <!-- Sidebar links -->
          <nav aria-label="Main" class="bg-gray-400 flex-1 w-64 px-1 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto ">
            <!-- Dashboards links -->
            <div x-data="{ isActive: false, open: false}">
              ...
              <a
                ...
                :class="{'bg-neutral-600 dark:bg-neutral-600': isActive || open}"
                role="button"
                aria-haspopup="true"
              ...
              <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Dashboards">
                ...
                <hr>
                 <a
                  href="{{ route('Cosecha.index') }}"
                  role="menuitem"
                  class="block p-2 text-sm text-gray-300 transition-colors duration-200 rounded-md dark:text-gray-900 dark:hover:text-light hover:text-white">
                  Cosechar&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-apple-whole"></i>
                </a>
                <a
                  href="{{ route('CosechasCerradas.index') }}"
                  role="menuitem"
                  class="block p-2 text-sm text-gray-300 transition-colors duration-200 rounded-md dark:text-gray-900 dark:hover:text-light hover:text-white">
            ...
            <div x-data="{ isActive: false, open: false }">
              ...
              <a
                ...
                @click="$event.preventDefault(); open = !open"
                class="flex items-center p-2 text-gray-100 transition-colors rounded-md dark:text-white hover:bg-neutral-600 dark:hover:bg-neutral-900"
                :class="{ 'bg-neutral-100 dark:bg-neutral-600': isActive || open }"
                role="button"
                aria-haspopup="true"
                :aria-expanded="(open || isActive) ? 'true' : 'false'"
              >
            ...
            <div x-data="{ isActive: false, open: false}">
              ...
              <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                ...
                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                <a
                  href="{{ route('Certificacion.index')}}"
                  role="menuitem"
                  class="block p-2 text-sm text-gray-300 transition-colors duration-200 rounded-md dark:text-gray-900 dark:hover:text-light hover:text-white">
...
<div class="max-w-2xl text-right mt-2 mb-2 mr-2 fixed bottom-0 right-0">
	<footer class="p-1 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-3 dark:bg-gray-800">
		<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com" class="hover:underline" target="_blank">Comercial Caro Hnos. SpA™</a>. All Rights Reserved.
    </span>
		<ul class="flex flex-wrap items-center mt-2 ml-2 sm:mt-0">
			<li>
				<a href="#" class="mr-4 text-sm text-white hover:underline md:mr-6 dark:text-white">Soporte</a>
			</li>
			<li>
				<a href="#" class="mr-4 text-sm text-white hover:underline md:mr-6 dark:text-white">Manual del Sistema
					</a>
			</li>
			{{-- <li>
        ...
        >
          ...
          <div class="flex flex-col h-screen">
            ...
            >
              ...
              <h2 id="settinsPanelLabel" class="text-xl font-medium text-gray-500 dark:text-light">Configuración del Sistema</h2>
            </div>
            <!-- Content -->
            <div class="flex-1 overflow-hidden hover:overflow-y-auto">
              <!-- Theme -->
              <div class="p-4 space-y-4 md:p-8">
                <h6 class="mb-5 text-center text-lg font-medium text-gray-400 dark:text-light">Menu Administrador</h6>
               ...
               >
                <span aria-hidden="true">
                  ...
                  >
                    ...
                    />
                     ...
                     <span aria-hidden="true" class="ml-auto">
                        <!-- active class 'rotate-180' -->
                        <svg
                        class="ml-5 w-4 h-4 transition-transform transform"
                        :class="{ 'rotate-180': open }"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                  ...
                  <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                     ...
                     <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                     <a
                        href="{{ route('CuentaCorriente.index')}}"
                        role="menuitem"
                  ...
                  {{-- boton nuevo --}}
                     ...
                     <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                        ...
                        <a
                           ...
                           role="menuitem"
                           class="text-left block p-2 text-sm text-gray-300 transition-colors duration-200 rounded-md dark:text-gray-900 dark:hover:text-light hover:text-white hover:bg-gray-500">
                           <i class="fa-solid fa-box"></i>&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-apple-whole"></i>&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-tag"></i>&nbsp;&nbsp;&nbsp;Envases,Especies,Variedades
                        </a>
                        {{-- <a
                           href="{{ route('CertificacionCuartel.index')}}"
                           role="menuitem"
               ...
               >
                <span aria-hidden="true">
                  ...
                  <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                     ...
                     <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                     <a
                        href="{{ route('CierreInicioTemporada.index')}}"
                        role="menuitem"
                        class="text-left block p-2 text-sm text-gray-300 transition-colors duration-200 rounded-md dark:text-gray-900 dark:hover:text-light hover:text-white hover:bg-gray-500">
              ...
              <div class="flex items-center justify-between px-4 pt-4 border-b dark:border-neutral-800">
                ...
                <div class="space-x-2">
                  <button
                    ...
                    :class="{'border-neutral-700 dark:border-neutral-600': activeTabe == 'action', 'border-transparent': activeTabe != 'action'}"
                  >
                    Tareas
                  </button>
                  <button
                    ...
                    class="px-px pb-4 transition-all duration-200 transform translate-y-px border-b focus:outline-none"
                    :class="{'border-neutral-700 dark:border-neutral-600': activeTabe == 'user', 'border-transparent': activeTabe != 'user'}"
                  >
